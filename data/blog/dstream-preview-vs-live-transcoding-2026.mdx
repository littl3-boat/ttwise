...
<TLDR>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="border-l-4 border-red-500 pl-4">
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400">"DStream looks clean in preview, but my live on TikTok looks softer or different right after I go live."</div>
    </div>
    <div className="border-l-4 border-blue-500 pl-4">
      <div className="font-bold text-blue-500">Search Intent</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">Preview looks fine but live is different after going live, TikTok transcode layer, why quality changes on viewers.</div>
    </div>
    <div className="border-l-4 border-green-500 pl-4">
      <div className="font-bold text-green-500">Key Conclusion</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">The preview is local, but TikTok delivers a transcoded ladder. If you send settings outside TikTok’s comfort zone, the platform re-encodes and your live looks different.</div>
    </div>
  </div>
</TLDR>
...
<div className="my-8">
  ...
  />
  <p className="text-center text-sm text-gray-500 mt-2">Preview is local. Live is re-encoded and delivered in multiple rungs based on viewer device and network.</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">If your source is too heavy, TikTok compresses it into mobile-safe rungs. That’s why the live looks softer than the preview.</p>
</div>
