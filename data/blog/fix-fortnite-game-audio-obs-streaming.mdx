...
<TLDR>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="border-l-4 border-red-500 pl-4">
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400">Fortnite 游戏声音在耳机里正常，但在 OBS 中无法捕获，而其他游戏却一切正常。</div>
    </div>
    <div className="border-l-4 border-blue-500 pl-4">
      <div className="font-bold text-blue-500">搜索意图</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">Fortnite OBS 没声音、OBS 捕获不到 Fortnite 音频、Fortnite 专用音频捕获设置。</div>
    </div>
    <div className="border-l-4 border-green-500 pl-4">
      <div className="font-bold text-green-500">关键结论</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">通常源于采样率不匹配或独占模式冲突。需统一采样率为 48kHz，禁用独占模式，并在 OBS 中手动锁定输出设备。</div>
    </div>
  </div>
</TLDR>
...
<div className="my-8">
  ...
  />
  <p className="text-center text-sm text-gray-500 mt-2">音频路由与快速修复图示：展示了音频信号从游戏到 Windows 再到 OBS 的流转路径及潜在故障点。</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">修复清单：按优先级排列的排查步骤，帮助你快速定位并解决 Fortnite 独有的静音问题。</p>
</div>
