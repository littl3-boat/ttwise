...
draft: false
description: "TikTok 的垂直画布布局很难搞？本文提供透明模板设计指南，教你如何利用 Tiktory 和 TikFinity 避开手机端 UI 遮挡，设计出完美的直播间插件布局。"
...
<TLDR>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="border-l-4 border-red-500 pl-4">
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400">TikTok 的手机端 UI（弹幕区、礼物槽）覆盖了屏幕近 30% 的区域，导致主播精心设计的插件常被遮挡。</div>
    </div>
    <div className="border-l-4 border-blue-500 pl-4">
      <div className="font-bold text-blue-500">搜索意图</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">TikTok 直播透明模板下载、竖屏直播安全区划分、TikTok 插件位置布局指南。</div>
    </div>
    <div className="border-l-4 border-green-500 pl-4">
      <div className="font-bold text-green-500">关键结论</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">必须使用透明模板划分“安全区”，将核心游戏画面居中，并将插件（如关注目标、礼物条）放置在顶部或中下部的“空白区”。建议先在手机端截屏预览，确保 OBS 中的布局不会在移动端被 UI 遮盖。</div>
    </div>
  </div>
</TLDR>
...
<div className="my-8">
  ...
  />
  <p className="text-center text-sm text-gray-500 mt-2">布局安全区划分图：标注了 TikTok 手机端的“遮挡区”与“安全区”，指导你将核心插件放置在不会被弹幕遮住的位置。</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">插件系统工作流：从 TikTok 信号捕捉到 Tiktory 渲染，再到 OBS 画面合成的完整系统流程图。</p>
</div>
