...
<TLDR>
  - **核心痛点**：新手不知道如何使用专业的 OBS 软件在 TikTok 上直播，以及如何获取必要的推流码（Stream Key）。
  - **搜索意图**：OBS 直播 TikTok 教程、TikTok 推流码怎么拿、OBS 设置 TikTok 直播比例。
  - **关键结论**：使用 OBS 直播 TikTok 的核心在于获取推流码（通常通过 TikTok Live Studio）并正确配置垂直画布（1080x1920）。相比 Live Studio，OBS 提供了更强的场景自定义能力和更稳定的编码表现，是进阶主播打造专业直播间的首选工具。
</TLDR>
...
![OBS Setup Flow](/static/images/how-to-stream-to-tiktok-using-obs/diagram-1.svg)
