...
date: "2025-12-10"
lastmod: "2026-02-10"
tags: ['TikTok Live', 'Overlay Template', 'Safe Zones', 'Streaming Design', 'User Interface']
draft: false
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">贴纸设计流程框架：从模板加载到安全区验证的完整设计流程，确保你的直播间在不同手机型号上都能完美显示。</p>
</div>
