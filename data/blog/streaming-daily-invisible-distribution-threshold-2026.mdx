...
<div className="my-8">
  ...
  />
  <p className="text-center text-sm text-gray-500 mt-2">If your stream never hits a test window, it feels like invisibility.</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">Consistency helps only after the algorithm sees proof of retention.</p>
</div>
