...
<div className="flex justify-center">
  <div className="w-[100%]">
    <img className="rounded-lg" src="/static/images/keep-tiktok-live-gaming-viewers-retention-guide-2025/banner.svg" alt="Stuck at low TikTok Live viewers in gaming streams" />
  </div>
</div>
