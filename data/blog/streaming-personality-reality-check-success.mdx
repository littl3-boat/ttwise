...
<TLDR>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="border-l-4 border-red-500 pl-4">
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400">新手主播往往认为只要投入足够的时间和购买昂贵的设备就能成功，却忽略了“人格魅力”这一残酷的准入门槛。</div>
    </div>
    <div className="border-l-4 border-blue-500 pl-4">
      <div className="font-bold text-blue-500">搜索意图</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">直播不火的原因、主播需要什么天赋、直播成功的真相。</div>
    </div>
    <div className="border-l-4 border-green-500 pl-4">
      <div className="font-bold text-green-500">关键结论</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">直播成功公式中，人格特质 > 社区经营 > 硬件设备。如果缺乏天然的幽默感或互动能力，单纯的“努力”只会导致挫败感。建议主播重新定义“成功”：从追求万人围观转向寻找志同道合的小圈子，以此获得长久的直播动力。</div>
    </div>
  </div>
</TLDR>
...
<div className="my-8">
  ...
  />
  <p className="text-center text-sm text-gray-500 mt-2">直播成功金字塔：揭示了人格魅力和社区经营在成功路径中远比硬件设备更重要。</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">直播收入预期图：展示了不同观众规模下可能的收入水平，提醒主播保持理性的经济预期。</p>
</div>
