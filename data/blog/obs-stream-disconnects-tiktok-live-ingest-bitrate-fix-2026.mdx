...
flowchart TD
    ...
    B --|"Red Square"|--> C["Connection Unstable"]
    B --|"Immediate Disconnect"|--> D["Ingest Rejection"]
    B --|"Lags"|--> E["Bitrate/Encoding Issue"]
    D --> F{"Check Keyframe Interval"}
    F --|"Not 2s"|--> G["Set to 2s"]
    F --|"Is 2s"|--> H{"Check Bitrate Spikes"}
    H --|"VBR or High CBR"|--> I["Force Strict CBR"]
    H --|"Low CBR"|--> J["Change Ingest Server"]
    
    style D fill:#fdd,stroke:#c00,stroke-width:2px
