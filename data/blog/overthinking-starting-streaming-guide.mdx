...
<TLDR>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="border-l-4 border-red-500 pl-4">
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400">Everyone says you have potential, but you're paralyzed by equipment anxiety and the fear of not being "ready" enough to start.</div>
    </div>
    <div className="border-l-4 border-blue-500 pl-4">
      <div className="font-bold text-blue-500">Search Intent</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">What do I need for my first stream, common beginner streamer worries, how to start streaming without gear.</div>
    </div>
    <div className="border-l-4 border-green-500 pl-4">
      <div className="font-bold text-green-500">Key Conclusion</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">Overthinking is the ultimate growth killer. Your current phone, headset, and console are enough. The goal isn't perfection; it's getting comfortable on camera. Just hit "Go Live" during your normal gaming time and upgrade as you learn.</div>
    </div>
  </div>
</TLDR>
...
<div className="my-8">
  ...
  />
  <p className="text-center text-sm text-gray-500 mt-2">Overthinking vs. Starting Simple: The simple path leads to action and feedback, while overthinking leads to paralysis.</p>
</div>
