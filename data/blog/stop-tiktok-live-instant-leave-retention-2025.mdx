...
<TLDR>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="border-l-4 border-red-500 pl-4">
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400">Total views are high, but concurrent viewers (CCU) are extremely low, with viewers "instantly leaving" and failing to stay.</div>
    </div>
    <div className="border-l-4 border-blue-500 pl-4">
      <div className="font-bold text-blue-500">Search Intent</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">Fixing instant viewer loss on TikTok Live, improving retention, and increasing watch time.</div>
    </div>
    <div className="border-l-4 border-green-500 pl-4">
      <div className="font-bold text-green-500">Key Conclusion</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">You must break the scrolling habit within 3 seconds. Optimize layout via the "Mute Test," visualize goals, and maintain continuous audio output.</div>
    </div>
  </div>
</TLDR>
...
<PostBanner
  ...
  caption="Turning drive-by scrollers into active viewers: The 3-second retention strategy for TikTok Live."
/>
...
<div className="my-8">
  ...
  />
  <p className="text-center text-sm text-gray-500 mt-2">TikTok Live Vertical Layout Strategy: Maximizing retention through layered layout design.</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">TikTok Live Viewer Decision Flow: The conversion process from visual attraction to emotional connection.</p>
</div>
