...
<TLDR>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="border-l-4 border-red-500 pl-4">
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400">New streamers are often misled by "fast growth" tactics, over-focusing on equipment while ignoring the core of streaming: personality and charisma.</div>
    </div>
    <div className="border-l-4 border-blue-500 pl-4">
      <div className="font-bold text-blue-500">Search Intent</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">Why streaming advice doesn't work, how to increase stream popularity, key factors for streaming success.</div>
    </div>
    <div className="border-l-4 border-green-500 pl-4">
      <div className="font-bold text-green-500">Key Conclusion</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">The foundation of success is authenticity. Viewers stay for connection, not perfect visuals. Instead of imitating others, focus on your own unique traits.</div>
    </div>
  </div>
</TLDR>
...
<div className="my-8">
  ...
  />
  <p className="text-center text-sm text-gray-500 mt-2">Streaming Advice Problem Illustration: Reveals why generic advice often fails to translate into actual growth.</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">Viewer Retention Motivation Model: Shows the different roles of skill, entertainment, and community connection in building a long-term audience.</p>
</div>
