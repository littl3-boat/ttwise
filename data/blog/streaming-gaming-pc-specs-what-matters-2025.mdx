...
<TLDR>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="border-l-4 border-red-500 pl-4">
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400">单机直播时，不知道该把预算花在 CPU 还是 GPU 上，经常遇到游戏流畅但直播卡顿的情况。</div>
    </div>
    <div className="border-l-4 border-blue-500 pl-4">
      <div className="font-bold text-blue-500">搜索意图</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">单机直播电脑配置推荐（2025 版），优化 OBS 编码性能。</div>
    </div>
    <div className="border-l-4 border-green-500 pl-4">
      <div className="font-bold text-green-500">关键结论</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">GPU 冗余比 CPU 核心数更重要。优先选择带 NVENC 的 NVIDIA 显卡，并留出 10-15% 的性能空间给 OBS。</div>
    </div>
  </div>
</TLDR>
...
<div className="my-8">
  ...
  />
  <p className="text-center text-sm text-gray-500 mt-2">性能分配解析图：直观展示了游戏渲染与 OBS 直播推流在硬件资源上的竞争关系。</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">单机直播决策图：根据你的预算和需求，帮助你决定在 CPU 或 GPU 上投入更多资源。</p>
</div>
