...
<TLDR>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="border-l-4 border-red-500 pl-4">
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400">新手主播不知道如何在 TikTok 直播间添加互动工具（如礼物提醒、聊天机器人、实时点赞数），导致直播间显得业余且互动率低。</div>
    </div>
    <div className="border-l-4 border-blue-500 pl-4">
      <div className="font-bold text-blue-500">搜索意图</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">TikTok 直播互动插件教程、TikFinity 设置指南、如何在直播中显示礼物特效。</div>
    </div>
    <div className="border-l-4 border-green-500 pl-4">
      <div className="font-bold text-green-500">关键结论</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">推荐使用 TikFinity 作为核心工具。所有工具均通过“浏览器源”接入。设置礼物反馈回路（如“收到玫瑰触发特定音效”）可将观众被动观看转化为主动参与。</div>
    </div>
  </div>
</TLDR>
...
<div className="my-8">
  ...
  />
  <p className="text-center text-sm text-gray-500 mt-2">互动工具性能对比：对比了 TikTok 原生工具与第三方方案在功能丰富度与系统占用上的平衡点。</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">TikTok 互动插件配置流程：从 TikFinity 后台配置到 Live Studio 浏览器源导入的完整路径。</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">互动工具集成概览：展示了从简单的礼物提醒到复杂的多平台聊天同步的三种主流技术路径。</p>
</div>
