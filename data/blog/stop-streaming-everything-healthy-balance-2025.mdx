...
<TLDR>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="border-l-4 border-red-500 pl-4">
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400">将每次游戏都变成直播，导致纯粹的娱乐变成枯燥的“工作”，引发创作倦怠。</div>
    </div>
    <div className="border-l-4 border-blue-500 pl-4">
      <div className="font-bold text-blue-500">搜索意图</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">平衡直播与生活、避免直播倦怠、提高直播内容质量。</div>
    </div>
    <div className="border-l-4 border-green-500 pl-4">
      <div className="font-bold text-green-500">关键结论</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">采用“场外积累，场内爆发”策略。离线模式积累素材，直播模式专注于预设的“钩子”和挑战。</div>
    </div>
  </div>
</TLDR>
...
<div className="my-8">
  ...
  />
  <p className="text-center text-sm text-gray-500 mt-2">直播决策树：判断当前状态适合“离线游玩”还是“上线直播”。</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">健康直播平衡图：离线与在线时间的黄金分配比例。</p>
</div>
