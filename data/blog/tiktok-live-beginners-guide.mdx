...
<TLDR>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="border-l-4 border-red-500 pl-4">
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400">新手面对 TikTok 直播时，往往不清楚起播门槛（如粉丝数）、设备要求以及如何快速吸引第一批观众。</div>
    </div>
    <div className="border-l-4 border-blue-500 pl-4">
      <div className="font-bold text-blue-500">搜索意图</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">TikTok 开直播教学、直播赚钱攻略、直播间搭建指南。</div>
    </div>
    <div className="border-l-4 border-green-500 pl-4">
      <div className="font-bold text-green-500">关键结论</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">2025 年开播 TikTok Live 的硬指标是 1000 粉丝和 16 岁以上。成功起步的关键不在于昂贵的相机，而在于前 10 分钟的黄金留存期、清晰的直播标题以及与观众的实时互动。</div>
    </div>
  </div>
</TLDR>
...
<div className="my-8">
  ...
  />
  <p className="text-center text-sm text-gray-500 mt-2">如何开启 TikTok 直播：展示了从手机 App 和电脑端启动直播的步骤流程。</p>
</div>
