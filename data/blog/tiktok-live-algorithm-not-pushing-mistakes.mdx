...
images: ["/static/images/tiktok-live-algorithm-not-pushing-mistakes/banner.svg", "/static/images/tiktok-live-algorithm-not-pushing-mistakes/diagram-1.svg", "/static/images/tiktok-live-algorithm-not-pushing-mistakes/explain-1.svg"]
authors: ["default"]
layout: PostLayout
...
<TLDR>
  - **核心痛点**：许多主播努力直播却始终卡在个位数场观，误以为是“限流”，实际上是因为触碰了算法的冷落机制。
  - **搜索意图**：TikTok 直播不给推流怎么办、直播间没人进的原因、如何提升直播间曝光。
  - **关键结论**：算法不推流通常由三个“致命伤”引起：标题过于笼统、开播前 30 秒节奏太慢、以及缺乏有效的互动循环。通过优化标题关键词、建立“开场 10 秒吸引”脚本和设置明确的互动指令，可以在 2-3 周内重新激活算法推流。
</TLDR>
...
![Mistakes vs Corrections](/static/images/tiktok-live-algorithm-not-pushing-mistakes/diagram-1.svg)
...
![Algorithm Push Loop](/static/images/tiktok-live-algorithm-not-pushing-mistakes/explain-1.svg)
