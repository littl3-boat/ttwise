...
<TLDR>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="border-l-4 border-red-500 pl-4">
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400">Streamers fear "streaming to nobody" and feel shadowbanned, when in reality, the stream lacks the "distribution signals" the algorithm needs.</div>
    </div>
    <div className="border-l-4 border-blue-500 pl-4">
      <div className="font-bold text-blue-500">Search Intent</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">TikTok Live diagnosis, why is nobody joining my live, TikTok Live algorithm explained.</div>
    </div>
    <div className="border-l-4 border-green-500 pl-4">
      <div className="font-bold text-green-500">Key Conclusion</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">TikTok Live is essentially a "distribution test." If account health is normal, failure usually stems from: 1. Packaging (title/cover) failing to explain the stream in 2 seconds; 2. Extremely low retention in the first 60 seconds; 3. Lack of a continuous interaction loop. Use this checklist to find and fix bottlenecks in 30 minutes.</div>
    </div>
  </div>
</TLDR>
...
<div className="my-8">
  ...
  />
  <p className="text-center text-sm text-gray-500 mt-2">TikTok Live Packaging Rule: Ensure a stranger can understand your stream in under 2 seconds.</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">TikTok Live Algorithm Diagnosis Flowchart: Quickly locate your stream's traffic bottleneck.</p>
</div>
