...
images: ["/static/images/tiktok-live-algorithm-not-pushing-stream/banner.svg", "/static/images/tiktok-live-algorithm-not-pushing-stream/diagram-1.svg", "/static/images/tiktok-live-algorithm-not-pushing-stream/explain-1.svg"]
authors: ["default"]
layout: PostLayout
...
<TLDR>
  - **核心痛点**：主播最怕“播了半天没人进”，感觉被平台限流，实际上是直播间缺乏让算法识别的“推流信号”。
  - **搜索意图**：TikTok 直播诊断、为什么直播间不进人、直播推流机制详解。
  - **关键结论**：TikTok 直播本质上是一个“分发测试”。如果账号权重正常，推流失败通常源于三点：1. 直播间包装（标题和封面）无法在 2 秒内让观众明白在播什么；2. 开播前 60 秒留存率极低；3. 缺乏持续的互动循环。通过本自检清单，可以在 30 分钟内找到并修复断流瓶颈。
</TLDR>
...
![TikTok Live Packaging Rule](/static/images/tiktok-live-algorithm-not-pushing-stream/explain-1.svg)
...
<div className="my-8 text-center">
  ![TikTok Live Algorithm Diagnosis Flowchart](/static/images/tiktok-live-algorithm-not-pushing-stream/diagram-1.svg)
</div>
