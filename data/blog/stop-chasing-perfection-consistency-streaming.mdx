...
<TLDR>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="border-l-4 border-red-500 pl-4">
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400">新手主播过度纠结于设备、灯光和 OBS 布局的“完美”，导致长期拖延，始终无法迈出点击“开始直播”的第一步。</div>
    </div>
    <div className="border-l-4 border-blue-500 pl-4">
      <div className="font-bold text-blue-500">搜索意图</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">直播需要什么设备、新手直播一定要摄像头吗、如何克服直播完美主义。</div>
    </div>
    <div className="border-l-4 border-green-500 pl-4">
      <div className="font-bold text-green-500">关键结论</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">直播界最扎心的真相是：90% 的潜在主播死于“准备不足”的假象。观众留下的理由 75% 取决于主播的人格魅力和互动质量，而技术完美度仅占 25%。与其等待完美的设备，不如建立稳定的直播频率。记住：Scruffy（简陋但真实）的内容往往比好莱坞级的冰冷制作更具吸引力。</div>
    </div>
  </div>
</TLDR>
...
<div className="my-8">
  ...
  />
  <p className="text-center text-sm text-gray-500 mt-2">完美主义对主播的影响：统计数据显示，90% 的潜在主播因为追求完美而从未开始。</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">观众真正看重的是什么：社区调查显示，人格魅力和互动远比技术完美更重要。</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">频率 vs 完美的增长曲线：12 个月的对比显示，稳定的直播频率在观众增长上远超完美主义策略。</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">成功主播的社区资源利用率：展示了社区支持在克服创作瓶颈中的关键作用。</p>
</div>
