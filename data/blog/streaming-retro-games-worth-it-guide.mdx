...
<TLDR>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="border-l-4 border-red-500 pl-4">
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400">许多新手主播担心直播老游戏（如《生化危机》、《寂静岭》）没有受众，因为这些游戏已经被通关无数次，缺乏新鲜感。</div>
    </div>
    <div className="border-l-4 border-blue-500 pl-4">
      <div className="font-bold text-blue-500">搜索意图</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">直播老游戏有人看吗、如何通过怀旧游戏涨粉、复古游戏直播策略。</div>
    </div>
    <div className="border-l-4 border-green-500 pl-4">
      <div className="font-bold text-green-500">关键结论</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">观众看老游戏直播不是为了剧情，而是为了看“你的第一次体验”或寻找怀旧共鸣。1. 强调“首次通关（Blind Playthrough）”；2. 专注于特定系列（如整个《生化危机》系列）以建立粉丝粘性；3. 提供独特的评论视角。怀旧游戏社区通常比热门游戏社区更忠诚、更活跃。</div>
    </div>
  </div>
</TLDR>
...
<div className="my-8">
  ...
  />
  <p className="text-center text-sm text-gray-500 mt-2">复古游戏直播决策流程图：帮助你根据自身目标和兴趣判断是否适合开始怀旧游戏直播。</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">直播经典游戏的利弊分析：深入了解怀旧游戏直播在增长速度、社区粘性和内容创作方面的优势与挑战。</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">复古游戏直播的优缺点总结：直观对比怀旧游戏直播在受众精准度与增长天花板之间的平衡。</p>
</div>
