...
<TLDR>
  - **核心痛点**：即使是专业配音演员或有经验的主播，在点击“开始直播”按钮的那一刻也会感到莫名的焦虑和“镜头恐惧症”。
  - **搜索意图**：直播紧张怎么办、如何克服镜头恐惧、直播前的心理建设。
  - **关键结论**：这种焦虑源于直播的实时性和不可撤回性，而非个人能力问题。1. 建立 1-3 分钟的“开场倒计时”缓冲期；2. 坦然承认尴尬（如“我刚才说错话了”）；3. 明白观众更喜欢真实的你而非完美的表演。通过高频练习和设定预热仪式，你可以逐渐将恐惧转化为创作动力。
</TLDR>
...
![The journey from anxiety to natural streaming](/static/images/streaming-stage-fright-camera-shyness/diagram-1.svg)

### Performance vs. Authenticity

![Performance pressure versus authentic connection](/static/images/streaming-stage-fright-camera-shyness/explain-1.svg)
