...
images: ["/static/images/tiktok-gift-overlays-see-animations-stream-2025/banner.svg", "/static/images/tiktok-gift-overlays-see-animations-stream-2025/diagram-1.svg", "/static/images/tiktok-gift-overlays-see-animations-stream-2025/explain-1.svg"]
authors: ["default"]
layout: PostLayout
...
<TLDR>
  - **The Visibility Gap**: TikTok gift animations play on the viewer's phone but don't natively appear on your stream overlay, leading to perceived "ignoring" of donors.
  - **Capture the Event**: Use TikFinity or Tiktory to intercept gift data and trigger custom animations in your OBS or TikTok Live Studio browser source.
  - **Sync the Experience**: Align your custom alert timing with TikTok's native animations to ensure your reactions feel immediate and authentic.
  - **Testing Tools**: Use the "Test Alert" function in your overlay tool while live to verify the browser source is correctly rendering the animations.
</TLDR>

![TikTok Gift Overlays Banner](/static/images/tiktok-gift-overlays-see-animations-stream-2025/banner.svg)
...
![Gift Overlay Flow](/static/images/tiktok-gift-overlays-see-animations-stream-2025/diagram-1.svg)
...
![Native vs Stream View](/static/images/tiktok-gift-overlays-see-animations-stream-2025/explain-1.svg)

*Comparison of the native mobile view vs the stream overlay view.* When a viewer sends a gift, TikTok shows its native animation on the viewer's device, while TikFinity/Tiktory captures the event data and triggers a custom alert in your OBS overlay. This creates a synchronized experience where viewers see TikTok's animations and your stream shows custom gift alerts.
