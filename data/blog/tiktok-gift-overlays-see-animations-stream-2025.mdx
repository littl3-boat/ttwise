...
<TLDR>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="border-l-4 border-red-500 pl-4">
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400">TikTok gift effects only play on the viewer's phone. Streamers often can't see them in their broadcast software, leading to missed reactions and lower engagement.</div>
    </div>
    <div className="border-l-4 border-blue-500 pl-4">
      <div className="font-bold text-blue-500">Search Intent</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">How to show TikTok gifts on stream, OBS gift plugin tutorial, TikFinity gift alert setup.</div>
    </div>
    <div className="border-l-4 border-green-500 pl-4">
      <div className="font-bold text-green-500">Key Conclusion</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">Use third-party tools like TikFinity to intercept gift data and render custom effects via an OBS browser source, achieving visual synchronization between the streamer and viewers.</div>
    </div>
  </div>
</TLDR>
...
<div className="my-8">
  ...
  />
  <p className="text-center text-sm text-gray-500 mt-2">Gift Overlay Flowchart: Shows the complete data flow from viewer gift-giving to the streamer's end and the live broadcast display.</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">Native View vs. Stream View Comparison: Illustrates why third-party tools are needed to bridge the visual gap in your broadcast software.</p>
</div>
