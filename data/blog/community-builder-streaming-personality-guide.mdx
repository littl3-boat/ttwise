...
<TLDR>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="border-l-4 border-red-500 pl-4">
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400">不具备“显眼包”或“大主播”那种极强的表演欲，担心自己过于温和的性格不适合竞争激烈的直播环境。</div>
    </div>
    <div className="border-l-4 border-blue-500 pl-4">
      <div className="font-bold text-blue-500">搜索意图</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">性格内向如何做主播、社区导向型直播策略、提升直播间凝聚力、温和型主播成长路径。</div>
    </div>
    <div className="border-l-4 border-green-500 pl-4">
      <div className="font-bold text-green-500">关键结论</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">温和、善于倾听的“社区构建者”性格是长线直播的超级力量。核心策略是通过设计固定仪式和共同目标，建立“社区飞轮”。</div>
    </div>
  </div>
</TLDR>
...
<div className="my-8">
  ...
  />
  <p className="text-center text-sm text-gray-500 mt-2">社区飞轮示意图：展示了从吸引观众到建立拥护者群体的良性循环。</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">社区成长仪式：这四个核心仪式通过建立信任和归属感，将偶然观众转化为忠实成员。</p>
</div>
