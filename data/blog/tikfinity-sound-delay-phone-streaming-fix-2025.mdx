...
<TLDR>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="border-l-4 border-red-500 pl-4">
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400">手机端直播时，TikFinity 声音提醒存在明显延迟（几秒钟），导致主播反应滞后，破坏直播间互动节奏。</div>
    </div>
    <div className="border-l-4 border-blue-500 pl-4">
      <div className="font-bold text-blue-500">搜索意图</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">TikFinity 声音延迟怎么调、手机直播礼物提醒延迟、TikTok 直播互动插件卡顿。</div>
    </div>
    <div className="border-l-4 border-green-500 pl-4">
      <div className="font-bold text-green-500">关键结论</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">延迟主要源于网络链路和手机后台限制。需切换 5GHz WiFi，精简提醒音效长度，并关闭手机的电池优化功能。</div>
    </div>
  </div>
</TLDR>
...
<div className="my-8">
  ...
  />
  <p className="text-center text-sm text-gray-500 mt-2">声音提醒优化路径：从网络、设置到硬件端的全方位排查方案。</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">TikFinity 声音延迟流程图：量化了礼物数据在云端和设备间传输的各个环节延迟。</p>
</div>
