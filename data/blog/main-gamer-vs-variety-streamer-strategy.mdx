...
<TLDR>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="border-l-4 border-blue-500 p-3 bg-blue-50/30">
      **Core Pain**: New streamers often struggle between 'playing only one game' and 'playing multiple games.' The former is fast for growth but prone to burnout; the latter is fun but harder to retain viewers.
    </div>
    <div className="border-l-4 border-blue-500 p-3 bg-blue-50/30">
      **Search Intent**: Main gamer vs variety streamer pros and cons, how to transition as a streamer, building a personal brand through gaming.
    </div>
    <div className="border-l-4 border-blue-500 p-3 bg-blue-50/30">
      **Key Conclusion**: The best strategy for 2025 is the '70/30 Rule': 70% of your time on a core game for discoverability, and 30% on variety to build your personality. Unless you're already a top creator, a pure 'variety' approach is extremely difficult to sustain initially.
    </div>
  </div>
</TLDR>
...
<div className="my-8">
  ...
  />
  <p className="text-center text-sm text-gray-500 mt-2">Main Gamer vs Variety Streamer Comparison: Each strategy has unique advantages and challenges that creators must weigh based on their goals.</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">Hybrid Growth Strategy: Gradually transitioning to personality-driven content while maintaining stable growth through a core game.</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">Streaming Strategy Decision Tree: Helps you decide whether to go the main gamer, variety, or hybrid route based on your goals and interests.</p>
</div>
