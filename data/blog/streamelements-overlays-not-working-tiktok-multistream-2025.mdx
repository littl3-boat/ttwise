...
<TLDR>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="border-l-4 border-red-500 pl-4">
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400">StreamElements overlays that work perfectly on Twitch/YouTube fail to display interactive effects when multi-streaming to TikTok.</div>
    </div>
    <div className="border-l-4 border-blue-500 pl-4">
      <div className="font-bold text-blue-500">Search Intent</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">Solving the issue of TikTok not displaying StreamElements overlays during multi-platform streaming (Restream/OBS).</div>
    </div>
    <div className="border-l-4 border-green-500 pl-4">
      <div className="font-bold text-green-500">Key Conclusion</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">StreamElements does not support the TikTok API. For multi-streaming, you must configure a separate TikFinity or Tiktory setup for your TikTok vertical scene.</div>
    </div>
  </div>
</TLDR>
...
<div className="my-8">
  ...
  />
  <p className="text-center text-sm text-gray-500 mt-2">Platform Compatibility Matrix: Shows the support levels of StreamElements across different streaming platforms.</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">Multi-Platform Overlay Setup Flowchart: Guiding you on how to correctly configure overlay routing when streaming to multiple platforms simultaneously.</p>
</div>
