...
<TLDR>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="border-l-4 border-red-500 pl-4">
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400">新手在 TikTok 直播游戏的第一周往往对数据感到迷茫，不知道什么样的增长速度和打赏水平才算“合格”。</div>
    </div>
    <div className="border-l-4 border-blue-500 pl-4">
      <div className="font-bold text-blue-500">搜索意图</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">TikTok 直播第一周数据分析、直播游戏收益、如何看直播数据。</div>
    </div>
    <div className="border-l-4 border-green-500 pl-4">
      <div className="font-bold text-green-500">关键结论</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">TikTok 的算法 discovery 极强，即使是零粉丝起步，第一周达到 20-50 个平均观众和一定的打赏收入也是完全可能的。核心在于利用好垂直屏幕的视觉冲击力和互动的即时性，而不是盲目追求昂贵的设备。</div>
    </div>
  </div>
</TLDR>
...
<div className="my-8">
  ...
  />
  <p className="text-center text-sm text-gray-500 mt-2">TikTok 游戏直播成功路径：从开启首播到实现稳定增长与变现的全过程。</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">TikTok 游戏直播关键指标拆解：影响成功的主要因素及平台核心优势。</p>
</div>
