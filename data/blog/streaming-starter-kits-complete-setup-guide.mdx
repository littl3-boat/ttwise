...
<TLDR>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="border-l-4 border-red-500 pl-4">
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400">新手在准备直播设备时常感到迷茫，不知道该优先投资什么硬件，导致买了昂贵但不实用的设备却依然无法开播。</div>
    </div>
    <div className="border-l-4 border-blue-500 pl-4">
      <div className="font-bold text-blue-500">搜索意图</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">直播新手入门设备、TikTok 直播电脑配置、高性价比直播套装。</div>
    </div>
    <div className="border-l-4 border-green-500 pl-4">
      <div className="font-bold text-green-500">关键结论</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">直播的“四大支柱”是：电脑、麦克风、摄像头和 OBS。1. 优先保证音频质量（观众对烂画质的容忍度高于烂音质）；2. 电脑 CPU 至少 6 核；3. TikTok 直播通常需要 1000 粉丝门槛。从基础配置开始，随着观众增长再逐步升级。</div>
    </div>
  </div>
</TLDR>
...
<div className="my-8">
  ...
  />
  <p className="text-center text-sm text-gray-500 mt-2">直播四大支柱：电脑、麦克风、摄像头和 OBS，构成了最基础且核心的直播系统。</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">设备升级优先级：音质 > 稳定性 > 画质 > 氛围装饰，合理分配预算才能事半功倍。</p>
</div>
