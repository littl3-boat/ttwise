...
<TLDR>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="border-l-4 border-red-500 pl-4">
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400">新手主播常陷入“玩热门游戏没流量”或“玩冷门游戏没人看”的困境，不知道如何平衡兴趣与涨粉。</div>
    </div>
    <div className="border-l-4 border-blue-500 pl-4">
      <div className="font-bold text-blue-500">搜索意图</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">直播选什么游戏容易火、如何通过游戏选择吸引第一批观众、直播增长策略。</div>
    </div>
    <div className="border-l-4 border-green-500 pl-4">
      <div className="font-bold text-green-500">关键结论</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">寻找“增长甜蜜点”。避开超饱和游戏，选择拥有稳定粉丝群但竞争适中的中型游戏，通过小众社区切入。</div>
    </div>
  </div>
</TLDR>
...
<div className="my-8">
  ...
  />
  <p className="text-center text-sm text-gray-500 mt-2">游戏选择策略图：评估市场状况、个人契合度和内容潜力的完整框架。</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">饱和度与增长对比：理解过度饱和类别与高增长机会之间的区别。</p>
</div>
