...
<TLDR>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="border-l-4 border-red-500 pl-4">
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400">新手不知道如何从主机（如 Xbox）过渡到 PC 直播，对硬件配置需求和预算分配感到困惑。</div>
    </div>
    <div className="border-l-4 border-blue-500 pl-4">
      <div className="font-bold text-blue-500">搜索意图</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">直播电脑配置推荐、低预算直播 PC、OBS 直播硬件要求。</div>
    </div>
    <div className="border-l-4 border-green-500 pl-4">
      <div className="font-bold text-green-500">关键结论</div>
      <div className="text-sm text-gray-600 dark:text-gray-400">你并不需要价值 2000 美元的顶级电脑才能开始直播。一台 500 美元左右的预装机（配备 i5/Ryzen 5 级别 CPU）就能胜任基础的 OBS 推流工作。硬件投入的优先级应为：CPU（核心编码能力）> 内存（多任务处理）> 显卡。对于主机玩家，采集卡是实现专业化直播的关键投资。</div>
    </div>
  </div>
</TLDR>
...
<div className="my-8">
  ...
  />
  <p className="text-center text-sm text-gray-500 mt-2">电脑直播方案对比图：从入门级到专业级直播主机的配置选择建议。</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">核心硬件需求表：解析 CPU、内存、显卡在直播中的不同权重及其重要性。</p>
</div>
...
<div className="my-8">
  <Image
    ...
    className="rounded-lg shadow-md"
  />
  <p className="text-center text-sm text-gray-500 mt-2">预算 vs 性能平衡点：寻找最适合新手的性价比直播电脑投资方案。</p>
</div>
